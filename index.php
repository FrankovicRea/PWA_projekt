    ...
    <body>
        ...
        <nav>
            <ul>
                ...
                <li><a href="sites/world_news.php"> World News </a></li>
                <li><a href="sites/sports.php"> Sport </a></li>
        ...
        <div class="main">
            ...
            <div class="row">
                <?php
                $query = "SELECT * FROM article WHERE prikaz=1 AND kategorija='w_news' LIMIT 4";
                ...
                while($row = mysqli_fetch_array($result)) {
                    ...
                    echo '<h1>';
                    echo '<a href="sites/news_article.php?id='.$row['id'].'">';
                    echo $row['naslov'];
                    echo '</a>';
                    echo '</h1>';
            ...
            <div class="row">
                <?php
                $query = "SELECT * FROM article WHERE prikaz=1 AND kategorija='sport' LIMIT 4";
                $result = mysqli_query($dbc, $query);
                $i=0;
                while($row = mysqli_fetch_array($result)) {
